 ...
 var SuapClient = function(authHost, clientID, redirectURI, scope) {
  ...
  this.getResource = function(scope, callback) {
  	$.ajax({
		...
		error: function(response) {
			//alert('Falha na comunicação com o SUAP GET RESOURCE');
      console.log('Falha na comunicação com o SUAP GET RESOURCE');
            console.log(response);
		}
    });
  };
  ...
  this.logout = function() {
  	$.ajax({
		...
		error: function(response) {
			alert('Falha na comunicação com o SUAP LOGOFF');
			console.log('Falha na comunicação com o SUAP LOGOFF');
            console.log(response);
		}
    });
  };
